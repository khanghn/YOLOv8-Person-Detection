...
def train(args, params):
    ...
    filenames = []
    for filename in os.listdir('/kaggle/input/coco2017-crowhuman-person/coco_crow/train/images/'):
        filenames.append('/kaggle/input/coco2017-crowhuman-person/coco_crow/train/images/' + filename)
...
def test(args, params, model=None):
    filenames = []
    for filename in os.listdir('/kaggle/input/coco2017-crowhuman-person/coco_crow/val/images/'):
        filenames.append('/kaggle/input/coco2017-crowhuman-person/coco_crow/val/images/' + filename)
